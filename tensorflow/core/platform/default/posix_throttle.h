...
#ifndef TENSORFLOW_CORE_PLATFORM_DEFAULT_POSIX_THROTTLE_H_
#define TENSORFLOW_CORE_PLATFORM_DEFAULT_POSIX_THROTTLE_H_

// Code was modified from gcs_throttle
...
#endif  // TENSORFLOW_CORE_PLATFORM_DEFAULT_POSIX_THROTTLE_H_
